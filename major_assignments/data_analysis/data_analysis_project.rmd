...
1. Do artists with more views/streams on average have songs that have similar characteristics represented in the data? (**WILL HAVE TO FIX CODE AND RESPONSE**)
...
2. Do shorter or longer songs gain more traction or popularity? (**Use whole data set not just top 10**)
...
Based off of the code, shorter songs receive more streams and views. 

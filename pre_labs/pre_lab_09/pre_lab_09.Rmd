...
**Answer** https://www.datawrapper.de/_/CcUGL/
...
From the previous map, the new map now just shows the state of Maryland and our data color-coded on a scale throughout the state. 
...
**Answer** Describe the changes from the previous map
The {{ fips_code }} now shows county names versus fips_code numbers with {{ county }}, and {{ pctmoore }} now shows percents rounded to the nearest tenth with {{ FORMAT(pctmoore, "00.0%")}}. 
...
https://www.datawrapper.de/_/nGdji/

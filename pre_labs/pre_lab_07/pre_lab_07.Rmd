...
```{r echo=FALSE}
census_api_key("606c34a89905c65f9f0e5279eb4c15d0b60d75ab", install=TRUE)
```
...
**Answer** Nevada is the state with the largest percentage growth. (About 35.1%)
...
**Answer** The county with the highest median household income is Howard County, MD. (About 129549)
...
**Answer** It should, or could, be "Howard County Wealthiest County in Maryland" or "Wealthiest Counties in Maryland."
...
**Answer** Calvert County and Montgomery County do not have a big or significant difference. Montgomery's value has a shorter margin of error, but both are around the same level. 

Is the difference between Howard and everyone else significant? 

**Answer** Yes, Howard County is the wealthiest county. You can see Howard rising to the top right surpassing the others with over 120,000 people. 
...
**Answer** Baltimore City, Maryland (37.4%), Allegany County (35.3%) and Calvert County (32.4%) are the top three counties with the largest increase in median income. No counties had median incomes fall, but Caroline County had the smallest change increase in median income. 
...
**Answer** One question we could ask is, "How does the amount of average household incomes for each zip code or school system affect high school graduate college enrollment percentages?" One thing that may make it harder to interpret is that average household incomes are titled "estimate" in the data table instead of something like "household_income."
...
**Answer** Average household incomes for high schools that have 60% or more graduates immediately enrolling in college is higher than the average household income for high schools with less than 40%.
...
**Answer** What are the top five high schools that have the most amount of highest percentages of high school graduates immediately enrolling in college and what are the average household incomes of these high school/school system areas?

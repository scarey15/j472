...
**Answer** The data frame the code outputs includes Ben Cardin's press release titles, dates of release, the URLs and their text. 
...
**Answer** The unique function kept the comma, which isn't a word, and just keeps the same words but seems to get rid of duplicates like one "dog" and one "cat." 
...
**Answer** This function lists 647091 "unique" words from Cardin's press releases. It also puts all the words in lowercase. These words aren't the most exciting or newsworthy.
...
**Answer** The graph showst the top 25 "unique" words, but these words include "the," "and," "by," "this," etc. These words aren't necessarily interesting as they are pretty common words. The only one which could be sort of unique is the 25th word, "maryland." 
...
**Answer** These words are definitely better and a bit more interesting, such as "baltimore," "infrastructure," "covid," "committee," and more. The span over the entire time period Cardin has been in office and released press releases. 
...
**Answer** In 2021, a lot of words surrounding "health" and "covid" are included. In 2022, there is no mention of "covid" but more on "funding" and "communities"; maybe some sort of rebuilding. In 2023, there are a bit more unique words such as "women," "rights" and "fire." Without context though, it's hard to grasp newsworthy items with only one word. 
...
**Task** Run the following code and describe the results.
**Answer** This code find two words together in 2021, that aren't in the stop words, that occur very often in Cardin's press releases. The top is "covid 19," following with "human rights," rescue words, locations and health related words. The last two words are "kweisi mfume" which is definitely unique.
...
**Task** Run the following code and describe the results.
**Answer** In 2022, "covid 19" is still present but not as important in Cardin's press releases. A lot of these words include locations and jurisdictions like "baltimore city," and talks of projects and money amounts. 
...
**Task** Run the following code and describe the results.
**Answer** In 2023, Cardin's most used words include "human rights" and "equal rights." Some of these words listed involve health, but not Covid-19. There seems to be a lot of equal rights talk including powers like the Supreme Court.  
...
**Answer** With only one word and no context, a lot of these words could swing either way as positive or negative. For example, the word "work," could be a positive connotation or negative. The word "trump" in 2021 is deemed as positive, which seems incorrect or a bit suspicious. Also, the word "supreme" could be questioned as well on being "positive." Also, "urgent" has been deemed as negative which I think could go either way. Overall, there just isn't context to these words to guarantee negative or positive sentiments. 

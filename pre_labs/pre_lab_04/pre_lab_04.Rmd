...
**Answer** There are many grantee names that are similar but spelled out/written out differently. So, they are the same group but just written differently, so they are made as different rows when they shouldn't be. 
...
**Answer** For Washington County Museum of Fine Arts, refinr changed it to all caps. For Charles County Arts Alliance Inc, refinr changed it to all caps, and removed the word "Inc."
...
**Answer** The WASHINGTON ADVENTIST UNIVERSITY was changed to all lower case. There are no other changes in the first 30 results. 
...
**Answer** No, the changes are not very substantial. Specifically, the "COMMISSIONE" and "COMMISSIONERS" rows did not change/join together. There don't seem to be many, if at all, changes. 

...
voters_by_county <- voters_by_county %>% mutate(pct_dem = DEM/TOTAL*100)
...
**Answer** R assumed the first column with Maryland totals as header titles, so it made those values the header column with x's and the numbers. 
...
**Answer** The Maryland column is now not the header, but the header now fills with x#'s like x1, x2, etc.
...
**Answer** We still need to get rid of the mass amount of periods in the first rows all the way down next to the Maryland jurisdiction names. 

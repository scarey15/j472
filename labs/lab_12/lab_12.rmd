...
One thing to note is there are 11 listed, the last being "trust account record" because it seems to have the same number and percentage found for the "account record keeping."
...
Besides reading through the sanctions documents provided, I think there is something else we can do to clarify this is the most important sanction. First, maybe we can write code for ngrams bigger than trigrams to get more context of phrases together and see where the trust accounts fall. Second, even just looking at the top ten trigrams, some seems similarly related to the trust accounts, such as "trust account failing," "collecting unreasonable fees," "unreasonable fees failing," "account record keeping" and "trust account record." We can look more into these phrases, how many times they occur and get their context from the sanctions to see how much attorney trust accounts lead to the most sanctions. 
